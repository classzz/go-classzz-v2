...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/classzz/EIPs/issues/150)
...
// CheckConfigForkOrder checks that we don't "skip" any forks, gczz isn't pluggable enough
