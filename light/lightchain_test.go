...
func makeHeaderChain(parent *types.Header, n int, db czzdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (czzdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() czzdb.Database {
	return odr.db
}
