...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/classzz/go-classzz-v2/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-classzz-v2 authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-classzz-v2 Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-classzz-v2"
	}
	if startOfSentence {
		return "The go-classzz-v2 library"
	}
	return "the go-classzz-v2 library"
}
