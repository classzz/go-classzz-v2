...
# 1. install gczz for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gczz
# 5. create gczz, attach and uninstall start menu entries
...
!define GROUPNAME "Classzz"
!define APPNAME "Gczz"
!define DESCRIPTION "Official Go implementation of the Classzz protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gczz is installed global
