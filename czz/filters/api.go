...
// information related to the Classzz protocol such als blocks, transactions and logs.
...
//
// https://czz.wiki/json-rpc/API#eth_newpendingtransactionfilter
...
//
// https://czz.wiki/json-rpc/API#eth_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(classzz.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as classzz.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria classzz.FilterQuery
...
//
// https://czz.wiki/json-rpc/API#eth_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(classzz.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
...
//
// https://czz.wiki/json-rpc/API#eth_getlogs
...
//
// https://czz.wiki/json-rpc/API#eth_uninstallfilter
...
//
// https://czz.wiki/json-rpc/API#eth_getfilterlogs
...
//
// https://czz.wiki/json-rpc/API#eth_getfilterchanges
