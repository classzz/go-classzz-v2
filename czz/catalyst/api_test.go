...
var (
	...
	// testAddr is the Classzz address of the tester account.
...
func startEthService(t *testing.T, genesis *core.Genesis, blocks []*types.Block) (*node.Node, *czz.Classzz) {
	t.Helper()
	...
	ethcfg := &czzconfig.Config{Genesis: genesis, Ethash: ethash.Config{PowMode: ethash.ModeFake}}
	ethservice, err := czz.New(n, ethcfg)
	if err != nil {
		t.Fatal("can't create czz service:", err)
	}
