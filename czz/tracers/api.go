...
// NewAPI creates a new API definition for the tracing methods of the Classzz service.
...
func (api *API) TraceCall(ctx context.Context, args czzapi.CallArgs, blockNrOrHash rpc.BlockNumberOrHash, config *TraceCallConfig) (interface{}, error) {
...
func (api *API) traceTx(ctx context.Context, message core.Message, txctx *txTraceContext, vmctx vm.BlockContext, statedb *state.StateDB, config *TraceConfig) (interface{}, error) {
	...
	case *vm.StructLogger:
		...
		return &czzapi.ExecutionResult{
			Gas:         result.UsedGas,
			Failed:      result.Failed(),
			ReturnValue: returnVal,
			StructLogs:  czzapi.FormatLogs(tracer.StructLogs()),
		}, nil
