...
// Config contains configuration options for of the CZZ and LES protocols.
type Config struct {
	// The genesis block, which is inserted if the database is empty.
	// If nil, the Classzz main net block is used.
...
func CreateConsensusEngine(stack *node.Node, chainConfig *params.ChainConfig, config *ethash.Config, notify []string, noverify bool, db czzdb.Database) consensus.Engine {
