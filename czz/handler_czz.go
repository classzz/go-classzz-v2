...
// ethHandler implements the czz.Backend interface to handle the various network
...
func (h *ethHandler) Handle(peer *czz.Peer, packet czz.Packet) error {
	...
	default:
		return fmt.Errorf("unexpected czz packet type: %T", packet)
	}
}
...
func (h *ethHandler) handleBodies(peer *czz.Peer, txs [][]*types.Transaction) error {
