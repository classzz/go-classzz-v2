...
// ProtocolName is the official short name of the `czz` protocol used during
// devp2p capability negotiation.
const ProtocolName = "czz"

// ProtocolVersions are the supported versions of the `czz` protocol (first
// is primary).
...
const (
	...
	// Protocol messages overloaded in czz/65
...
// Packet represents a p2p message in the `czz` protocol.
type Packet interface {
	Name() string // Name returns a string corresponding to the message type.
	Kind() byte   // Kind returns the message type.
}

// StatusPacket is the network packet for the status message for czz/64 and later.
...
// GetBlockHeadersPacket represents a block header query over czz/66
...
// BlockHeadersPacket represents a block header response over czz/66.
...
// GetBlockBodiesPacket represents a block body query over czz/66.
...
// BlockBodiesPacket is the network packet for block content distribution over czz/66.
...
// BlockBodiesRLPPacket66 is the BlockBodiesRLPPacket over czz/66
...
// GetNodeDataPacket represents a trie node data query over czz/66.
...
// NodeDataPacket is the network packet for trie node data distribution over czz/66.
...
// GetReceiptsPacket represents a block receipts query over czz/66.
...
// ReceiptsPacket is the network packet for block receipts distribution over czz/66.
...
// ReceiptsPacket66 is the czz-66 version of ReceiptsRLPPacket
...
// PooledTransactionsPacket is the network packet for transaction distribution over czz/66.
...
// PooledTransactionsRLPPacket66 is the czz/66 form of PooledTransactionsRLPPacket
