...
// Peer is a collection of relevant information we have about a `czz` peer.
type Peer struct {
...
// Version retrieves the peer's negoatiated `czz` protocol version.
...
// ReplyPooledTransactionsRLP is the czz/66 version of SendPooledTransactionsRLP.
...
// ReplyBlockHeaders is the czz/66 version of SendBlockHeaders.
...
// ReplyBlockBodiesRLP is the czz/66 version of SendBlockBodiesRLP.
...
// ReplyNodeData is the czz/66 response to GetNodeData.
...
// ReplyReceiptsRLP is the czz/66 response to GetReceipts.
