...
type peerConnection struct {
	...
	version uint       // Czz protocol version number to switch strategies
...
func (p *peerConnection) SetHeadersIdle(delivered int, deliveryTime time.Time) {
	p.rates.Update(czz.BlockHeadersMsg, deliveryTime.Sub(p.headerStarted), delivered)
	atomic.StoreInt32(&p.headerIdle, 0)
}
...
func (p *peerConnection) SetBodiesIdle(delivered int, deliveryTime time.Time) {
	p.rates.Update(czz.BlockBodiesMsg, deliveryTime.Sub(p.blockStarted), delivered)
	atomic.StoreInt32(&p.blockIdle, 0)
}
...
func (p *peerConnection) SetReceiptsIdle(delivered int, deliveryTime time.Time) {
	p.rates.Update(czz.ReceiptsMsg, deliveryTime.Sub(p.receiptStarted), delivered)
	atomic.StoreInt32(&p.receiptIdle, 0)
}
...
func (p *peerConnection) SetNodeDataIdle(delivered int, deliveryTime time.Time) {
	p.rates.Update(czz.NodeDataMsg, deliveryTime.Sub(p.stateStarted), delivered)
	atomic.StoreInt32(&p.stateIdle, 0)
}
...
func (p *peerConnection) HeaderCapacity(targetRTT time.Duration) int {
	cap := p.rates.Capacity(czz.BlockHeadersMsg, targetRTT)
...
func (p *peerConnection) BlockCapacity(targetRTT time.Duration) int {
	cap := p.rates.Capacity(czz.BlockBodiesMsg, targetRTT)
...
func (p *peerConnection) ReceiptCapacity(targetRTT time.Duration) int {
	cap := p.rates.Capacity(czz.ReceiptsMsg, targetRTT)
...
func (p *peerConnection) NodeDataCapacity(targetRTT time.Duration) int {
	cap := p.rates.Capacity(czz.NodeDataMsg, targetRTT)
...
func newPeerSet() *peerSet {
	return &peerSet{
		...
		rates: msgrate.NewTrackers(log.New("proto", "czz")),
	}
}
...
func (ps *peerSet) HeaderIdlePeers() ([]*peerConnection, int) {
	...
	throughput := func(p *peerConnection) int {
		return p.rates.Capacity(czz.BlockHeadersMsg, time.Second)
	}
	return ps.idlePeers(czz.ETH65, czz.ETH66, idle, throughput)
}
...
func (ps *peerSet) BodyIdlePeers() ([]*peerConnection, int) {
	...
	throughput := func(p *peerConnection) int {
		return p.rates.Capacity(czz.BlockBodiesMsg, time.Second)
	}
	return ps.idlePeers(czz.ETH65, czz.ETH66, idle, throughput)
}
...
func (ps *peerSet) ReceiptIdlePeers() ([]*peerConnection, int) {
	...
	throughput := func(p *peerConnection) int {
		return p.rates.Capacity(czz.ReceiptsMsg, time.Second)
	}
	return ps.idlePeers(czz.ETH65, czz.ETH66, idle, throughput)
}
...
func (ps *peerSet) NodeDataIdlePeers() ([]*peerConnection, int) {
	...
	throughput := func(p *peerConnection) int {
		return p.rates.Capacity(czz.NodeDataMsg, time.Second)
	}
	return ps.idlePeers(czz.ETH65, czz.ETH66, idle, throughput)
}
