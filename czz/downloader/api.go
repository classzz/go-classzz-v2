...
// Syncing provides information when this nodes starts synchronising with the Classzz network and when it's finished.
...
type SyncingResult struct {
	...
	Status  classzz.SyncProgress `json:"status"`
}
