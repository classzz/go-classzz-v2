...
func main() {
	...
	// Create a Clique network based off of the devnet config
...
func makeSealer(genesis *core.Genesis) (*node.Node, *czz.Classzz, error) {
	...
	// Start the node and configure a full Classzz node on it
	stack, err := node.New(config)
	if err != nil {
		return nil, nil, err
	}
	// Create and register the backend
	ethBackend, err := czz.New(stack, &ethconfig.Config{
		Genesis:         genesis,
