...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Classzz presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gczz wallet import /path/to/my/presale.wallet

will prompt for your password and imports your czz presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Classzz presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gczz wallet [options] /path/to/my/presale.wallet
...
between classzz nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gczz account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gczz account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another classzz instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gczzConfig{Node: defaultNodeConfig()}
	// Load config file.
