...
import (
	...
	"github.com/classzz/go-classzz-v2/internal/cmdtest"
	"github.com/classzz/go-classzz-v2/rpc"
	"github.com/docker/docker/pkg/reexec"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "gczz-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func runGczz(t *testing.T, args ...string) *testgczz {
	...
	// Boot "gczz". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gczz-test", args...)
