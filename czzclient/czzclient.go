...
// Client defines typed wrappers for the Classzz RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*classzz.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (classzz.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q classzz.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q classzz.FilterQuery, ch chan<- types.Log) (classzz.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q classzz.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg classzz.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg classzz.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg classzz.CallMsg) (uint64, error) {
...
func (ec *Client) GetConvertItem(ctx context.Context) ([]*types.ConvertItem, error) {
	var result []*RPCConvertItem
	err := ec.c.CallContext(ctx, &result, "tewaka_getConvertItems")

	var result1 []*types.ConvertItem
	for _, v := range result {
		item := &types.ConvertItem{
			ID:          v.ID.ToInt(),
			AssetType:   (uint8)(v.AssetType),
			ConvertType: (uint8)(v.ConvertType),
			TxHash:      v.TxHash,
