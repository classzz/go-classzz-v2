...
// Package bind generates Classzz contract Go bindings.
//
// Detailed usage document and tutorial available on the go-classzz-v2 Wiki page:
// https://github.com/classzz/go-classzz-v2/wiki/Native-DApps:-Go-bindings-to-Classzz-contracts
package bind
