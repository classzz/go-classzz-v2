...
func (mc *mockCaller) CallContract(ctx context.Context, call classzz.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call classzz.CallMsg) ([]byte, error) {
