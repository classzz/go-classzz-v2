...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain classzz.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to classzz-type signature.
		signature[64] -= 27 // Transform V from Classzz-legacy to 0/1
	}
