...
import (
	...
	"github.com/classzz/go-classzz-v2/p2p/simulations"
	"github.com/classzz/go-classzz-v2/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	classzz, err := czz.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, classzz, &config)
	if err != nil {
		return nil, err
	}
	return classzz, nil
