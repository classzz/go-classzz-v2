...
// mapped from textual names used in the tests below to actual Classzz private
...
// address retrieves the Classzz address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Classzz address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/classzz/go-classzz-v2/issues/17593). Whilst this
