...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db czzdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db czzdb.Database) error {
