...
// ecrecover extracts the Classzz account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Classzz address
...
// Classzz testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     czzdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Classzz address of the signing key
...
func New(config *params.CliqueConfig, db czzdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Classzz address recovered
