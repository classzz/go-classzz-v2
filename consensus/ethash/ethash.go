...
// all blocks' seal as valid, though they still have to conform to the Classzz
// consensus rules.
...
// still have to conform to the Classzz consensus rules.
...
// they still have to conform to the Classzz consensus rules.
...
func (ethash *Ethash) APIs(chain consensus.ChainHeaderReader) []rpc.API {
	...
	// to both czz and ethash namespaces.
	return []rpc.API{
		{
			Namespace: "eth",
			Version:   "1.0",
