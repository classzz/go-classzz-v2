...
// This test reproduces https://github.com/classzz/go-classzz-v2/issues/17837 where the
...
// It is the reproducer for https://github.com/classzz/go-classzz-v2/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-classzz-v2-test-ipc-%d-%d", os.Getpid(), rand.Int63())
