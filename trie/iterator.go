...
type NodeIterator interface {
	...
	//
	// Before adding a similar mechanism to any other place in Gczz, consider
	// making trie.Database an interface and wrapping at that level. It's a huge
	// refactor, but it could be worth it if another occurrence arises.
	AddResolver(czzdb.KeyValueStore)
}
...
type nodeIterator struct {
	...
	resolver czzdb.KeyValueStore // Optional intermediate resolver above the disk layer
}
...
func (it *nodeIterator) AddResolver(resolver czzdb.KeyValueStore) {
...
func (it *differenceIterator) AddResolver(resolver czzdb.KeyValueStore) {
...
func (it *unionIterator) AddResolver(resolver czzdb.KeyValueStore) {
	panic("not implemented")
}
