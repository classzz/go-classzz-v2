...
func (s *spongeDb) NewBatch() czzdb.Batch                    { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) czzdb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w czzdb.KeyValueWriter) error { return nil }
