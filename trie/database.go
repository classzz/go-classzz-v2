...
type Database struct {
	diskdb czzdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb czzdb.KeyValueStore) *Database {
...
func NewDatabaseWithConfig(diskdb czzdb.KeyValueStore, config *Config) *Database {
...
func (db *Database) DiskDB() czzdb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch czzdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
