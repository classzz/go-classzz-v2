...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gczz.ipc", false, filepath.Join(os.TempDir(), "gczz.ipc")},
		{"data", "gczz.ipc", false, "data/gczz.ipc"},
		{"data", "./gczz.ipc", false, "./gczz.ipc"},
		{"data", "/gczz.ipc", false, "/gczz.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gczz.ipc", true, `\\.\pipe\gczz.ipc`},
		{"data", "gczz.ipc", true, `\\.\pipe\gczz.ipc`},
		{"data", `\\.\pipe\gczz.ipc`, true, `\\.\pipe\gczz.ipc`},
	}
