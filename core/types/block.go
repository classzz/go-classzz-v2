...
// Package types contains data types related to Classzz consensus.
package types
...
type Block struct {
	...
	// These fields are used by package czz to track
	// inter-peer block relay.
	ReceivedAt   time.Time
	ReceivedFrom interface{}
}

// "external" block encoding. used for czz protocol, etc.
...
// EncodeRLP serializes b into the Classzz RLP block format.
