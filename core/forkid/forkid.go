...
// Package forkid implements EIP-2124 (https://eips.classzz.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the Classzz fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Classzz fork ID from an existing chain instance.
