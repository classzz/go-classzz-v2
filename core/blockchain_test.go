...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (czzdb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (czzdb.Database, func()) {
...
//
// https://github.com/classzz/go-classzz-v2/pull/15941
...
//
// Details at:
//  - https://github.com/classzz/go-classzz-v2/issues/18977
//  - https://github.com/classzz/go-classzz-v2/pull/18988
...
//   with 0.001 czz (thus created but no code)
...
func TestEIP2718Transition(t *testing.T) {
	...
	expected := params.TxGas + params.TxAccessListAddressGas + params.TxAccessListStorageKeyGas + vm.GasQuickStep*2 + vm.WarmStorageReadCost2929 + vm.ColdSloadCostEIP2929
