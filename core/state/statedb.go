...
// Package state provides a caching layer atop the Classzz state trie.
package state
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/classzz/go-classzz-v2/pull/16485#issuecomment-380438527),
