...
// account array.
func checkStateAccounts(t *testing.T, db czzdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db czzdb.Database, root common.Hash) error {
...
func checkStateConsistency(db czzdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(czzdb.Database), srcRoot)
