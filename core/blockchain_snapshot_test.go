...
// It can be used for testing that restart Gczz normally.
...
// It can be used for testing that restart Gczz after the crash.
...
// Tests a Gczz restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gczz was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gczz was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gczz was running with snapshot enabled. Then restarts without
...
// Tests the Gczz was running with snapshot enabled and resetHead is applied.
...
// Tests the Gczz was running with a complete snapshot and then imports a few
