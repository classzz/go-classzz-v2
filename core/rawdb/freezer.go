...
//   reserving it for go-classzz-v2. This would also reduce the memory requirements
//   of Gczz, and thus also GC overhead.
type freezer struct {
...
func (f *freezer) freeze(db czzdb.KeyValueStore) {
