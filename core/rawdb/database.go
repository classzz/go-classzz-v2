...
import (
	...
	"github.com/classzz/go-classzz-v2/czzdb/leveldb"
...
func NewDatabase(db czzdb.KeyValueStore) czzdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db czzdb.KeyValueStore, freezer string, namespace string, readonly bool) (czzdb.Database, error) {
...
func NewMemoryDatabase() czzdb.Database {
...
func NewMemoryDatabaseWithCap(size int) czzdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string, readonly bool) (czzdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string, readonly bool) (czzdb.Database, error) {
...
func InspectDatabase(db czzdb.Database, keyPrefix, keyStart []byte) error {
