...
func NewTable(db czzdb.Database, prefix string) czzdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) czzdb.Iterator {
...
func (t *table) NewBatch() czzdb.Batch {
...
func (b *tableBatch) Replay(w czzdb.KeyValueWriter) error {
