...
import (
	...
	"github.com/classzz/go-classzz-v2/signer/fourbyte"
...
func (ui *headlessUi) OnApprovedTx(tx czzapi.SignTransactionResult) {}
...
func tmpDirName(t *testing.T) string {
	d, err := ioutil.TempDir("", "czz-keystore-test")
	if err != nil {
		t.Fatal(err)
	}
...
func TestSignTx(t *testing.T) {
	var (
		list      []common.Address
		res, res2 *czzapi.SignTransactionResult
		err       error
	)
