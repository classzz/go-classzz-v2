 ...
 * @author Gary Rong<garyrong@classzz.org>, Martin Swende <martin.swende@classzz.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the classzz.
    uint sectionSize;
