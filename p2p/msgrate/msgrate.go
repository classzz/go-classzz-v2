...
// most of Classzz's existence, so might as well go with it.
...
// An Classzz node doesn't need hundreds of connections to operate correctly,
...
type Tracker struct {
	...
	// (eg. czz.getHeaders vs snap.getAccountRange).
